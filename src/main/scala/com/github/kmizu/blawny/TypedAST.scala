...
object TypedAST {
  ...
  case class LetDeclaration(type_ : Type, location: Location, variable: String, declaredType: Type, value: TypedAST, body: TypedAST) extends TypedAST
  ...
  case class LetFunctionDefinition(type_ : Type, location: Location, name: String, body: FunctionLiteral, expression: TypedAST) extends TypedAST
